  ...
  <main class="flex-1 overflow-y-auto px-4 py-6">
    ...
    {#if !judgingEnabled}
      ...
      <div class="max-w-sm mx-auto text-center space-y-4 mt-12">
        ...
        <div
          class="w-12 h-12 border-4 border-[#FE5428] border-t-transparent rounded-full animate-spin mx-auto mt-8"
        ></div>
      </div>
    ...
    {:else if isFirstTeam && $currentTeamRune}
      ...
      <div class="max-w-md mx-auto space-y-4">
        ...
        <div
          class="flex flex-col gap-3 p-4 rounded-lg border border-[#2E2E2E] bg-[#101010]"
        >
          <div>
            <h3 class="text-white font-semibold">{$currentTeamRune.name}</h3>
